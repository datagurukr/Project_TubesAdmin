        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" href="/admin/event/list/1">사용자 알림</a> </li>
                    <li class="nav-item"> <a class="nav-link" href="/admin/event/list/2">광고주 알림</a> </li>
                </ul>
                                ...
                                <table class="table table-sm table-bordered text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <select class="custom-select event-select" name="sale">
                                                    <option value="">선택</option>                                                    
                                                    <option value="all" <? if ( $sale == 'all' ) { echo 'selected'; }; ?>>전체</option>
                                    ...
                                    <tbody>
                                        ...
                                        if ( $response['status'] == 200 ) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <? 
                                                    if ( $row['notice_free'] ==  1 ) { 
                                                        echo '전체'; 
                                                    } elseif ( $row['notice_free'] ==  2 ) { 
                                                        echo '무료'; 
                                                    } elseif ( $row['notice_free'] ==  3 ) { 
                                                        echo '유료'; 
                                                    }; 
                                                    ?>
                                                </td>
                                                ...
                                                <td><a href="#!" data-toggle="modal" data-target="#preview-noty-<? echo $num; ?>"><i class="fa fa-search"></i></a></td>
                                                
                                                <div class="modal fade" id="preview-noty-<? echo $num; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
