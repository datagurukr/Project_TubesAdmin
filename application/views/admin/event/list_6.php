        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" href="/admin/event/list/6">공지사항</a> </li>
                    <li class="nav-item"> <a class="nav-link" href="/admin/event/list/7">불만사항</a> </li>
                </ul>
                <div class="tab-content">
                    <form class="tab-pane active" id="t1" role="tabpanel">
                                    ...
                                    <tbody>
                                        ...
                                        if ( $response['status'] == 200 ) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/admin/event/list/8?post_id=<? echo $row['post_id']; ?>">
                                                        <? echo $row['post_title']; ?>
                                                    </a>    
                                                </td>
                                                <td><? echo $row['post_target']; ?></td>
                        ...
                        <div class="text-right"> <a href="#!" class="btn btn-danger" data-toggle="modal" data-target="#confirm-del">선택삭제</a> <a href="/admin/event/list/8" class="btn btn-primary">등록</a> </div>
                        <nav>
