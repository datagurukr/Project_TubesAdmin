    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" enctype="application/x-www-form-urlencoded" class="validation-forme validation-post1">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-6">
                                    <label>발송대상</label>
                                    <input type="text" class="form-control" placeholder="발송대상" name="post_target" value="<? echo $row['post_target']; ?>"> </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="text-right">
                                <button type="button" class="btn btn-primary" onclick="validationPost1(false,'confirm')">저장</button>
